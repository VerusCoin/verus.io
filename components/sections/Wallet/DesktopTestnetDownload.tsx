      ...
      <StyledSubMenuDiv>
        ...
        >
          <DefaultText fam="geoHead" fontSz="menu">
            {t('cards.desktop.dropdown.dropdown')}
          </DefaultText>
        ...
        <StyledSubMenu openSubMenu={dropdown}>
          <StyledMenuItem href={winApp} download>
            <SVGs name="windows" />
            <DefaultText fam="geoHead" fontSz="menu">
              {t('cards.desktop.dropdown.windows')}
            </DefaultText>
          </StyledMenuItem>
          <StyledMenuItem href={macApp} download>
            <SVGs name="macOS" />
            <DefaultText fam="geoHead" fontSz="menu">
              {t('cards.desktop.dropdown.mac')}
            </DefaultText>
          </StyledMenuItem>
          <StyledMenuItem href={linuxApp} download>
            <SVGs name="linux" />
            <DefaultText fam="geoHead" fontSz="menu">
              {t('cards.desktop.dropdown.linux')}
            </DefaultText>
          </StyledMenuItem>
          <StyledMenuItem href={armApp} download>
            <SVGs name="linux" />
            <DefaultText fam="geoHead" fontSz="menu">
              {t('cards.desktop.dropdown.arm')}
            </DefaultText>
          </StyledMenuItem>
        </StyledSubMenu>
      </StyledSubMenuDiv>
...
export default DesktopTestnetDownload
