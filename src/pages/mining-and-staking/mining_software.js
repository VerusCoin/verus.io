    ...
    <>
      ...
      >
        ...
        <p className="w-3/4 mt-2 mb-8 text-sm">
          <span className="font-bold">System requirements: </span>64bit CPU/OS,
          CPU with AES-NI and AVX instructions. Windows or Linux (Ubuntu
          tested). 4GB Memory.
        </p>
        ...
        <table className="w-full border-collapse table-fixed font-p">
          <tbody>
            ...
            <tr className="bg-gray-100">
              ...
              <td className="w-1/6 p-4 text-center ">
                <a href="https://github.com/BloodyNora/Docker" target="_blank">
                  Download
                </a>
              </td>
            </tr>
