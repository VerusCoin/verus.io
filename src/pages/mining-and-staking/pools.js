    ...
    <>
      <div className="container grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-4">
        ...
        <div className="max-w-5xl p-6 md:col-span-3">
          ...
          <table className="w-3/4 font-light border-collapse table-fixed font-p md:w-1/2">
            <thead>
              <tr>
                <th className="w-3/4 px-4 py-2"></th>
                <th className="w-1/4 px-4 py-2 font-light text-center">Fee</th>
              </tr>
            </thead>
            <tbody>
              <tr>
          ...
          <table className="w-3/4 mb-32 font-light border-collapse table-fixed font-p md:w-1/2">
            <thead>
              <tr>
                <th className="w-3/4 px-4 py-2 font-light"></th>
                <th className="w-1/4 px-4 py-2 font-light text-center">Fee</th>
              </tr>
            </thead>
            <tbody>
