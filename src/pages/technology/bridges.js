      ...
      <div className="container grid max-w-5xl grid-cols-1 gap-6 mt-8 mb-12 md:grid-cols-4">
        ...
        <div className="max-w-5xl p-6 md:col-span-3">
          ...
          <p className="my-8">
            ...
            external blockchains and their currencies to the Verus blockchain.
            This means that users can freely transfer coins from another blockchain
          ...
          <p className="my-8">
            ...
            ecosystem. This value (tokenized ETH and all ERC-20 tokens) can
          ...
          <p className="my-8">
            ...
            on Verus also become available on the Ethereum network as ERC-20 tokens,
            making a Verus token launch plus the Verus/ETH bridge one of the best ways
