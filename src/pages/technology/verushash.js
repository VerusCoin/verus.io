        ...
        <div className="justify-center max-w-5xl p-6 md:col-span-3">
          ...
          <div className="grid grid-cols-1 mt-8 mb-8 md:grid-cols-2 md:gap-8">
            <div className="flex flex-row items-center flex-shrink-0">
              <img src="/images/CPU.png" alt="CPU image" width="136.5" />
              <p className="font-light leading-normal font-p">
                Mining with a CPU is most profitable.
              </p>
            </div>
            <div className="flex flex-row items-center flex-shrink-0">
              <img src="/images/GPU.png" alt="GPU image" width="136.5" />
              <p className="font-light leading-normal font-p">
                Mining with a GPU can be profitable.
              </p>
            </div>
            <div className="flex flex-row items-center flex-shrink-0">
              <img src="/images/FPGA.png" alt="FPGA image" width="136.5" />
              <p className="font-light leading-normal font-p">
                There are no Bitstreams available to mine on FPGA's.
              </p>
            </div>
            <div className="flex flex-row items-center">
              <img src="/images/ASIC.png" alt="ASIC image" width="136.5" />
              <p className="font-light leading-normal font-p">
