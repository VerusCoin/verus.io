  ...
  return (
    <>
      ...
      <IndexPage
        ...
        menuRef="/technology"
        nextRoutePath={`/technology/${nextRoute.path}`}
      ...
      >
        ...
        <div className="grid grid-cols-1 p-8 my-16 bg-center bg-cover rounded md:grid-cols-2 md:gap-6 bg-features-bg">
          ...
          <div className="flex flex-row items-center flex-shrink-0">
            <img src="/images/icons/noICO.png" alt="no ico image" width="100" />
            <p className="pl-3 text-lg font-semibold text-white font-p">
              No ICO was held
            </p>
          </div>
          ...
          <div className="flex flex-row items-center flex-shrink-0">
            <img src="/images/icons/noDEV.png" alt="no dev image" width="100" />
            <p className="pl-3 text-lg font-semibold text-white font-p">
