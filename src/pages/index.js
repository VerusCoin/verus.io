          ...
          <div className="max-w-3xl text-left sm:pt-2 section-2">
            ...
            <div className="flex flex-col items-center justify-center w-full mt-12 space-y-6 md:flex-row md:space-y-0 md:space-x-4 md:justify-start">
              <Link href="/mining-and-staking">
                <button className="px-6 py-5 text-white border-0 rounded-full custombutton md:px-12 sm:mr-2 bg-bluebutton-default hover:bg-bluebutton-hover">
                  Earn in the Network Economy
                </button>
              </Link>
              <Link href="/technology">
                <button className="px-12 py-5 bg-transparent border-2 border-black border-solid rounded-full custombutton hover:bg-gray-200">
