          ...
          <ul className="z-20 items-center pb-4 mt-2 text-center md:flex md:h-16 md:pb-0">
                        ...
                        >
                          {menu.external ? (
                            <a
                              href={menu.url}
                              target="_blank"
                              className="block py-2 no-underline whitespace-nowrap cursor-pointer external text-navlink-default hover:text-navlink-hover"
                            >
                              {menu.name}
                            </a>
                          ) : (
                            <Link href={menu.url}>
                              <a className="block py-2 no-underline whitespace-nowrap cursor-pointer text-navlink-default hover:text-navlink-hover">
                                {menu.name}
                              </a>
                            </Link>
                          )}
            ...
            <li className="flex items-center ">
              <Link href="/wallet" className="p-0 m-0">
                <button
                  onClick={() => setNavbarOpen(false)}
                  className="flex-shrink-0 px-8 py-2 mx-2 text-base text-white border-0 rounded-full bg-bluebutton-default hover:bg-bluebutton-hover focus:outline-none md:py-3 custombutton"
                >
                  Get Wallet
                </button>
              </Link>
